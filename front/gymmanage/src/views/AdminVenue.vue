    ...
    <div class="app-container">
      ...
      <div class="box">
        ...
        <div class="filter-container">
          <el-row>
            <el-col :span="3"><el-input  placeholder="场地号" v-model="pagination.queryString"  class="filter-item"></el-input></el-col>
        ...
        <el-table size="small" current-row-key="id" :data="dataList" stripe highlight-current-row>
          <el-table-column  fixed prop="roomid" align="center" label="房间号"></el-table-column>
          <el-table-column prop="area" label="房间面积" align="center"></el-table-column>
          <el-table-column prop="note" label="备注"  align="center"></el-table-column>
          <el-table-column prop="courseid" label="被使用课程id" align="center"></el-table-column>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="房间面积" prop="area">
                    <el-input  type="text" v-model="formData.area"/>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="课程id" prop="courseid">
                    <el-input  type="text" v-model="formData.courseid"/>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
        ...
        <!-- 编辑标签弹层 -->
        <div class="add-form">
          <el-dialog title="编辑场地信息" v-model="dialogFormVisible4Edit">
